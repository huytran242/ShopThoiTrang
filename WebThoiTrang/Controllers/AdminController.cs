...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public async Task<IActionResult> CreateCategory([Bind("CategoryId,Name,Description")] ProductType category)
//        {
//            if (!ModelState.IsValid)
//            {
...
//            [HttpPost]
//            [ValidateAntiForgeryToken]
//            public async Task<IActionResult> EditCategory(Guid id, [Bind("CategoryId,Name,Description")] ProductType category)
//            {
